...
print("Decision Tree Classifier: ", dtc_pred)
print("Logistic Regression: ", lr_pred)
print("Naive Bayes: ", nb_pred)
print("Support Vector Machine (Linear Kernel): ", svm_lin_pred)
print("Support Vector Machine (Sigmoid Kernel): ", svm_sig_pred)
